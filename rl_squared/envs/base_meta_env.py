...
class BaseMetaEnv(gym.Env, ABC):
    """
    Outline expected functionality for environments being \
      used in meta-learning experiments.
    """
    ...
    def sample_task(self) -> None:
        """
        Sample a new multi-armed bandit problem \
            from distribution over problems.
    ...
    def step(self, action: Union[int, np.ndarray]) -> Tuple:
        ...
        Additionally, as per the RL^2 paper this wrapper updates 
        the observation returned to include the previous
