...
class MultiprocessingVecEnv(VecEnv):
    def __init__(self, env_fns: List[Callable[[], gym.Env]]):
        ...
        self.remotes, self.work_remotes \
            = zip(*[mp.Pipe() for _ in range(n_envs)])
        self.processes = []
    ...
    def step_async(self, actions: np.ndarray) -> None:
        ...
        Args:
            actions (np.ndarray): Numpy array of actions to 
            take in each of the environments.
    ...
    def step_wait(self) -> VecEnvStepReturn:
        """
        Wait for results of taking a step \
    ...
    def set_attr(
        ...
        Args:
            ...
            indices (VecEnvIndices): Indices of the environments 
            for which to set the attribute.
