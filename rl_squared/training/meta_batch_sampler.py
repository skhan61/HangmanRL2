...
class MetaBatchSampler:
    ...
    #     print(meta_episode_length)
    #     num_meta_episodes = self.rewards.shape[1]
    #     print(num_meta_episodes)
    ...
    def sample(self, advantages: torch.Tensor, num_minibatches: int):
        ...
        for start_ind in range(0, num_meta_episodes, num_envs_per_batch):
            ...
            if start_ind + num_envs_per_batch > num_meta_episodes:
                # Adjust the last batch to prevent index out of bounds
                num_envs_per_batch = num_meta_episodes - start_ind
            ...
            yield obs_batch, recurrent_states_actor_batch, \
                recurrent_states_critic_batch, actions_batch, \
                    value_preds_batch, return_batch, \
                        done_masks_batch, old_action_log_probs_batch, adv_targ
